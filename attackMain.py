...
def parse_args():
    ...
    mifgsm_parser = subparser.add_parser("mifgsm")
    mifgsm_parser.add_argument('-step_size', type=float, default=0.0004)
    mifgsm_parser.add_argument('-epsilon', type=float, default=0.002)
    mifgsm_parser.add_argument('-max_iter', type=int, default=10)  # PGD-10 default
    mifgsm_parser.add_argument('-num_random_init', type=int, default=0)
    mifgsm_parser.add_argument('-decay_factor', type=float, default=0.2)
    mifgsm_parser.add_argument('-loss', type=str, choices=['Entropy', 'Margin'], default='Entropy')

    spgd_parser = subparser.add_parser("sPGD")
    spgd_parser.add_argument('-epsilon', type=float, default=0.002)
    spgd_parser.add_argument('-max_iter', type=int, default=10)  # PGD-10 default
    spgd_parser.add_argument('-num_random_init', type=int, default=0)
    spgd_parser.add_argument('-loss', type=str, choices=['Entropy', 'Margin'], default='Entropy')

    epgd_parser = subparser.add_parser("ePGD")
    epgd_parser.add_argument('-epsilon', type=float, default=0.002)
    epgd_parser.add_argument('-max_iter', type=int, default=10)  # PGD-10 default
    epgd_parser.add_argument('-num_random_init', type=int, default=0)
    epgd_parser.add_argument('-loss', type=str, choices=['Entropy', 'Margin'], default='Entropy')


    cwinf_parser = subparser.add_parser("CWinf")
    cwinf_parser.add_argument('-step_size', type=float, default=0.0004)
    ...
    cwinf_parser.add_argument('-loss', type=str, choices=['Entropy', 'Margin'], default='Margin')
    ...
    cw2_parser.add_argument('-max_iter', type=int, default=600)
    cw2_parser.add_argument('-stop_early', action='store_false', default=True)
    cw2_parser.add_argument('-stop_early_iter', type=int, default=60)
...
def main(args):
    ...
    elif args.attacker == 'mifgsm':
        attacker = mifgsm(model, task=args.task, targeted=args.targeted, step_size=args.step_size,
                       epsilon=args.epsilon, max_iter=args.max_iter,
                       batch_size=args.batch_size, num_random_init=args.num_random_init,
                       loss=args.loss, EOT_size=args.EOT_size, EOT_batch_size=args.EOT_batch_size, verbose=1,decay_factor=args.decay_factor)
    elif args.attacker == 'sPGD':
        attacker = sPGD(model, task=args.task, targeted=args.targeted,
                       epsilon=args.epsilon, max_iter=args.max_iter,
                       batch_size=args.batch_size, num_random_init=args.num_random_init,
                       loss=args.loss, EOT_size=args.EOT_size, EOT_batch_size=args.EOT_batch_size, verbose=1)
    elif args.attacker == 'ePGD':
        attacker = ePGD(model, task=args.task, targeted=args.targeted,
                       epsilon=args.epsilon, max_iter=args.max_iter,
                       batch_size=args.batch_size, num_random_init=args.num_random_init,
                       loss=args.loss, EOT_size=args.EOT_size, EOT_batch_size=args.EOT_batch_size, verbose=1)
    ...
    if args.attacker == 'FGSM':
        ...
        attacker_param = [args.max_iter, args.epsilon, args.num_random_init, args.EOT_size,args.decay_factor]
    elif args.attacker == 'sPGD':
        attacker_param = [args.max_iter, args.epsilon, args.num_random_init, args.EOT_size]
    elif args.attacker == 'ePGD':
        attacker_param = [args.max_iter, args.epsilon, args.num_random_init, args.EOT_size]
